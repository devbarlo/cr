...
async def tmgif(event):
    ...
    if sad:
        jepthon = f"**˛ JEP ، ٰ𝖦𝗂𝖿 𝖲ِ𝖺ٰ𝖣 . .**\n"
        jepthon += f"✛━━━━━━━━━━━━━✛\n"
        jepthon += f"**الـمتحـرڪـة الأولـى **"
        await event.client.send_file(event.chat_id, sad, caption=jepthon, reply_to=lMl10l)
