...
from . import jepthon, edit_delete, reply_id
...
@jepthon.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}لستة قنواتي الرسمية [𝗧ُِٔ𝗢ٍَِ𝗢َِّ𝗟َٖ𝗦َ]<buttonurl:t.me/JepThon> [𝗝ََِ𝗠ٓ𝗧َُِْٓ𝗛ُ𝗢َ𝗡ٍَ]<buttonurl:t.me/JepThon> ",
    },
)
async def _(event):
