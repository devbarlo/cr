...
@jepthon.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@jepthon.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
@jepthon.on(admin_cmd(pattern="بلي$"))
...
@jepthon.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@jepthon.on(admin_cmd(pattern="كت$"))
async def ithker(knopis):
...
@jepthon.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(Jepthon_5erok))

    
@jepthon.on(admin_cmd(pattern="اذكار عشر$"))    
...
@jepthon.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
...
@jepthon.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
