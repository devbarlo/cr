...
'''
mm = '''
قم بلأنضمام الى قناة جيبثون @cr_source 
'''
...
keyboard = [
  ...
  [
    Button.url("قناة السورس", "https://t.me/cr_source")
    ]
]
...
async def start(event):
  ...
  async with bot.conversation(event.chat_id) as x:
    keyboard = [
      ...
      [
        Button.url("المطور", "https://t.me/cr_source")
        ]
    ]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\nشكرا لأستخدامك سورس كرستين", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم انهاء جميع الجلسات شكراً لأستخدامك كرستين.", buttons=keyboard)
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("القناة", "https://t.me/cr_source")
        ]
    ]
